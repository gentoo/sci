...
# @ECLASS-VARIABLE: INTEL_DIST_MINOR
# @DESCRIPTION:
...
_isdp_get-sdp-year() {
	...
	_intel_sdp_year=${_intel_sdp_year%%_u*}
...
isdp_get-sdp-dir() {
	local _intel_sdp_dir="opt/intel/${INTEL_SUBDIR}_$(_isdp_get-sdp-year).${INTEL_DIST_MINOR}.$(ver_cut 4)"
	echo "${_intel_sdp_dir}"
}
...
# @FUNCTION: intel-sdp-r2_pkg_pretend
# @DESCRIPTION:
#
...
# @FUNCTION: intel-sdp-r2_pkg_nofetch
# @DESCRIPTION:
...
# @FUNCTION: intel-sdp-r2_src_install
# @DESCRIPTION:
# Install everything
...
# @FUNCTION: intel-sdp-r2_pkg_postinst
# @DESCRIPTION:
# Test for all things working
intel-sdp-r2_pkg_postinst() {
	debug-print-function ${FUNCNAME} "${@}"
...
# @FUNCTION: intel-sdp-r2_pkg_postrm
# @DESCRIPTION:
# Sanitize cache links
intel-sdp-r2_pkg_postrm() {
	debug-print-function ${FUNCNAME} "${@}"
