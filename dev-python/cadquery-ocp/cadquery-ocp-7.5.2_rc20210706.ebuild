...
MY_COMMIT="9a6210e3c490e741719ccdada900c70e58b09c91"
OCCT_PV=$(ver_cut 1-3)

DESCRIPTION="Python wrapper for OCCT generated using pywrap"
HOMEPAGE="https://github.com/CadQuery/OCP"
SRC_URI="https://github.com/CadQuery/OCP/archive/${MY_COMMIT}.tar.gz -> ${P}.tar.gz"
...
RDEPEND="~sci-libs/opencascade-${OCCT_PV}[json,tbb,vtk]"
DEPEND="${RDEPEND}
	>=dev-python/cadquery-pywrap-${OCCT_PV}_rc0[${PYTHON_USEDEP}]
"

S="${WORKDIR}/OCP-${MY_COMMIT}"
BUILD_DIR="${S}"
