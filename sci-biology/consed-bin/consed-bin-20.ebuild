...
src_install() {
	dobin consed_linux32bit consed_linux32bit_dyn || die
	dobin consed_linux64bit consed_linux64bit_static || die
	# consed_linux_itanium

	dobin misc/{mktrace/mktrace,phd2fasta/phd2fasta,454/sff2scf} || die
