...
MY_BASE_PV=${PV/_pre/-pre-}
MY_PV=${MY_BASE_PV%_p*}
MY_SRC_PV=${MY_BASE_PV/_p/-revision-}
MY_P="${PN}-${MY_PV}"
MY_SRC_P="${PN}-${MY_SRC_PV}"

DESCRIPTION="Crystallographic Object-Oriented Toolkit for model building, completion and validation"
HOMEPAGE="http://www.ysbl.york.ac.uk/~emsley/coot/"
RESTRICT="mirror"
if [[ ${MY_PV} = *pre* ]]; then
	SRC_URI="http://www.ysbl.york.ac.uk/~emsley/software/pre-release/${MY_SRC_P}.tar.gz"
else
