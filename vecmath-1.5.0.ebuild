...
# tar -cjf vecmath-1.5.0.tar.bz2 vecmath/
# cvs -d :pserver:alistair64@cvs.dev.java.net:/cvs export -r rel-1_5_0-fcs vecmath-test
# tar -cjf vecmath-test-1.5.0.tar.bz2 vecmath-test/
...
#SRC_URI="http://download.java.net/media/java3d/builds/stable/${P}.tar.gz http://download.java.net/media/java3d/builds/stable/${PN}-test-${PV}.tar.gz"

SRC_URI="http://dev.gentoo.org/~nichoj/distfiles/${P}.tar.bz2
		test? ( http://dev.gentoo.org/~nichoj/distfiles/${PN}-test-${PV}.tar.bz2 )"
KEYWORDS="~amd64"
SLOT="0"
